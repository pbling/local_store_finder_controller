...
class RegisterNewsPage extends StatefulWidget {
  const RegisterNewsPage({Key? key}) : super(key: key);

  @override
  _RegisterNewsPageState createState() => _RegisterNewsPageState();
}

class _RegisterNewsPageState extends State<RegisterNewsPage> {
