...
class RegisterCouponPage extends StatefulWidget {
  const RegisterCouponPage({Key? key}) : super(key: key);

  @override
  _RegisterCouponPageState createState() => _RegisterCouponPageState();
}

class _RegisterCouponPageState extends State<RegisterCouponPage> {
